            ...
            <main>
                <div class="table-container">
                    ...
                    <div class="button-add">
                        <button type="button" onclick="location.href = './add-order.jsp'" ><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                            </svg>Add orders</button>
                    </div>
                    <table class="table" style="width: 100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>10-1-2022</td>
                                <td>$99.99</td>
                                <td> <a href="./update-order.jsp" style="color: green"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-repeat" viewBox="0 0 16 16">
