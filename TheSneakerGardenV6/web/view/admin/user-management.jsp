            ...
            <main>
                <div class="table-container">
                    ...
                    <div class="button-add">
                        <button type="button" onclick="location.href = './add.jsp'" ><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                    ...
                    <table class="table" style="width: 100%">
                        ...
                        <tbody>
                            <tr>
                                <td>KH_01</td>
                                <td>Meredith Ermintrude</td>
                                <td>ermintrude@gmail.com</td>
                                <td>Android</td>
                                <td>New York, USA</td>
                                <td> <a href="./update-user.jsp" style="color: green"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-repeat" viewBox="0 0 16 16">
