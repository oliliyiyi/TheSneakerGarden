            ...
            <main>
                <div class="table-container">
                    ...
                    <div class="button-add">
                        <h1>Admin</h1>
                        <button type="button" onclick="location.href = './user-management?action=add_admin'" ><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
