...
INSERT INTO dbo.Products(CategoryID, BrandID, ProductName, Price, ImageLink, [Description], [Status])
VALUES(1, 1, N'Nike Dunk Low – Barber Shop Grey', 700000, N'https://sneakerholicvietnam.vn/wp-content/uploads/2022/07/nike-dunk-low-barber-shop-grey-dh7614-500.jpg', N'Faded side panels and classic red, white and blue piping celebrates trusted barbers to help you look good. The padded, low-cut collar lets you take your signature style anywhere — in comfort.', 1)
INSERT INTO dbo.Products(CategoryID, BrandID, ProductName, Price, ImageLink, [Description], [Status])
...
INSERT INTO dbo.Products(CategoryID, BrandID, ProductName, Price, ImageLink, [Description], [Status])
VALUES(2, 1, N'Nike Everyday Training Ankle Socks – Amethyst', 309000, N'https://sneakerholicvietnam.vn/wp-content/uploads/2022/06/tat-vo-nike-everyday-training-ankle-socks-amethyst-dh5485-565.jpg', N'The Nike Academy Socks are designed to keep you comfortable during play with soft, sweat-wicking fabric with arch support.', 1)
INSERT INTO dbo.Products(CategoryID, BrandID, ProductName, Price, ImageLink, [Description], [Status])
VALUES(2, 1, N'Nike Cushioned Crew Socks', 359000, N'https://sneakerholicvietnam.vn/wp-content/uploads/2022/06/tat-vo-nike-cushioned-crew-socks-da2401-903.jpg', N'Power through your workout with the Nike Everyday Cushioned Socks. The thick terry sole gives you extra comfort for foot drills and lifts, while a ribbed arch band wraps your midfoot for a supportive feel.', 1)
INSERT INTO dbo.Products(CategoryID, BrandID, ProductName, Price, ImageLink, [Description], [Status])
...
INSERT INTO dbo.Products(CategoryID, BrandID, ProductName, Price, ImageLink, [Description], [Status])
VALUES(3, 2, N'Adidas Adicolor Bucket Hat – Blue', 400000, N'https://sneakerholicvietnam.vn/wp-content/uploads/2021/12/mu-adidas-adicolor-bucket-hat-blue-fm1336.jpg', N'Keep it comfortable. Keep it classic. A trusty cap never goes out of style. Head to the game or hang with friends, no matter what is on your schedule, this hat keeps you covered with a comfy cotton build and a moisture-wicking sweatband. An embroidered adidas Badge of Sport on the front keeps your look legit.', 1)
INSERT INTO dbo.Products(CategoryID, BrandID, ProductName, Price, ImageLink, [Description], [Status])
...
INSERT INTO dbo.Products(CategoryID, BrandID, ProductName, Price, ImageLink, [Description], [Status])
VALUES(4, 2, N'Adidas Essential Crossbody Bag – Blue', 1000000, N'https://sneakerholicvietnam.vn/wp-content/uploads/2021/12/tui-adidas-essential-crossbody-bag-blue-fl9660.jpg', N'Every day is an adventure, and with this adidas backpack you are prepared. Inspired by outdoor gear, it has a top zip pocket so you can quickly access your keys, wallet or mobile. An external compartment keeps your laptop securely stowed but easy to reach.', 1)
INSERT INTO dbo.Products(CategoryID, BrandID, ProductName, Price, ImageLink, [Description], [Status])
...
VALUES(1, 3, N'Great quality, super comfortable. The price is really great for all the nice features the shoe offers.', N'2022-02-02', 4)
INSERT INTO dbo.Review(ProductID, CustomerID, [Message], ReviewDate, Rating)
VALUES(1, 4, N'Honestly beat my expectations, as comfy as the yeezy 350s imo', N'2022-02-04', 4)
INSERT INTO dbo.Review(ProductID, CustomerID, [Message], ReviewDate, Rating)
VALUES(5, 3, N'Pretty good purchase. Really comfortable to wear for long hours.', N'2022-03-04', 5)
INSERT INTO dbo.Review(ProductID, CustomerID, [Message], ReviewDate, Rating)
VALUES(8, 5, N'Great shoe. Usually wear a 12 but I could have went for an 11.5. Might try to return them for a better size', N'2022-05-06', 3 )
INSERT INTO dbo.Review(ProductID, CustomerID, [Message], ReviewDate, Rating)
VALUES(10, 3, N'Very comfortable and they look good! I would size down a half size from usual Nike size', N'2022-06-05', 5)
INSERT INTO dbo.Review(ProductID, CustomerID, [Message], ReviewDate, Rating)
VALUES(13, 4, N'Obsessed with these shoes, got them a couple days ago and have been wearing them ever since. The flower/butterfly patches are super cute', N'2022-01-03', 4)
INSERT INTO dbo.Review(ProductID, CustomerID, [Message], ReviewDate, Rating)
VALUES(16, 5, N'Got these as a gift for my boyfriend and he loves them. Great for a general wear trainer and they are easy to clean and look after.', N'2022-04-13', 4)
INSERT INTO dbo.Review(ProductID, CustomerID, [Message], ReviewDate, Rating)
VALUES(16, 3, N'So happy with these - They look great and super comfy even from the first wear', N'2022-02-15', 4 )
GO
